...
type DNSMasqOption struct {
	// +kubebuilder:validation:Enum=server;rev-server;srv-host;txt-record;ptr-record;rebind-domain-ok;naptr-record;cname;host-record;caa-record;dns-rr;auth-zone;synth-domain;filter-A;filter-AAAA
	Key    string   `json:"key"`
